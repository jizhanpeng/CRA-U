...
def main():
    ...
    # Data loading code
    img_ids = glob(os.path.join('inputs', config['dataset'], 'training', 'images_hair_removal_512', '*' + config['img_ext']))
    img_ids = [os.path.splitext(os.path.basename(p))[0] for p in img_ids]

    val_ids = glob(os.path.join('inputs', config['dataset'], 'training', 'images_hair_removal_512', '*' + config['img_ext']))
    ...
    train_dataset = Dataset(
        ...
        img_dir=os.path.join('inputs', config['dataset'], "training", 'images_hair_removal_512'),
        mask_dir=os.path.join('inputs', config['dataset'], "training", 'masks512'),
    ...
    for epoch in range(config['epochs']):
        ...
        fn_current_time = datetime.now()
        print("time:", fn_current_time - sn_current_time)
...
if __name__ == '__main__':
    s_current_time = datetime.now()
    print("now time:", s_current_time)

    main()

    f_current_time = datetime.now()
    print("now time:", f_current_time)
    print("time:", f_current_time - s_current_time)
